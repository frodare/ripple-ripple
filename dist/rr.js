...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./rr.css */ 1);
	
	var ELEMENT_CLASS = 'ripple-ripple';
	...
	var insertRippleElement = function insertRippleElement(wrapper) {
	...
	var positionRippleElement = function positionRippleElement(wrapper, rippleElement, pageX, pageY) {
		var posX = wrapper.offsetLeft,
		    posY = wrapper.offsetTop;
	
		var buttonWidth = wrapper.offsetWidth,
		...
		var x = pageX - posX - buttonWidth / 2;
		var y = pageY - posY - buttonHeight / 2;
	...
	var removeRippleElementAfterAnimation = function removeRippleElementAfterAnimation(rippleElement) {
		rippleElement.addEventListener('animationend', function () {
			return rippleElement.remove();
		});
	};
	
	var setupSingleRipple = function setupSingleRipple(wrapper, pageX, pageY) {
		var rippleElement = insertRippleElement(wrapper);
		positionRippleElement(wrapper, rippleElement, pageX, pageY);
		removeRippleElementAfterAnimation(rippleElement);
		return rippleElement;
	};
	
	var startRipple = function startRipple(wrapper, pageX, pageY) {
		var e1 = setupSingleRipple(wrapper, pageX, pageY);
		var e2 = setupSingleRipple(wrapper, pageX, pageY);
	
		e1.style.webkitAnimationPlayState = 'running';
	
		setTimeout(function () {
			return e2.style.webkitAnimationPlayState = 'running';
		}, 150);
	...
	var attachRippleRipple = function attachRippleRipple(wrapper) {
		wrapper.addEventListener('click', function (ev) {
			var done = startRipple(wrapper, ev.pageX, ev.pageY);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../~/css-loader!./rr.css */ 2);
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./rr.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./rr.css");
